SELECT
    ...
    COALESCE(tw_clienti_Insegna, TW_Clienti_Ragione_Sociale) AS NomeCliente, 
    TW_Clienti.TW_Clienti_Cap AS Cap,
    TW_Clienti.TW_Clienti_Localita AS Localita,
    TW_Clienti.TW_Clienti_Indirizzo AS Indirizzo,
    TW_Clienti.TW_Clienti_P_IVA AS PartitaIva,
